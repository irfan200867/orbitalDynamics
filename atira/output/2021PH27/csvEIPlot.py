...
plt.annotate(r'$\mathbf{F}$', xy=(df.e[0], df.inc[0]), xytext=(df.e[0], 1.01*df.inc[0]))
plt.annotate(r'$\mathbf{L}$', xy=(df.e[len(df.e) - 1], df.inc[len(df.inc) - 1]), xytext=(df.e[len(df.e) - 1], 1.01*df.inc[len(df.inc) - 1]))
